...
const answerDocumentWrite = new Answer("document.write()");
const answerConsoleLog = new Answer("console.log()");
const answerWindowAlert = new Answer("window.alert()");
const answerAllOfTheAbove = new Answer("All of the above");

const question2 = new Question(2, "Which of the following methods can be used to display data in some form using Javascript?", [answerDocumentWrite, answerConsoleLog, answerWindowAlert, answerAllOfTheAbove], answerAllOfTheAbove)

const answerStringify = new Answer("stringify()");
const answerParse = new Answer("parse()");
const answerConvert = new Answer("convert()");
const answerNone = new Answer("None of the above");

const question3 = new Question(3, "Which function is used to serialize an object into a JSON string in Javascript?", [answerStringify, answerParse, answerConvert, answerNone], answerStringify);
